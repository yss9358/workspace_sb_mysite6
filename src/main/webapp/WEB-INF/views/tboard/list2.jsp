						...
						<div id="paging">
							<ul>
								<c:if test="${boardMap.prev}">
									<li><a href="${pageContext.request.contextPath}/tboard/list2?crtPage=${boardMap.startPageBtnNo-1}">◀</a></li>
								</c:if>
								...
								<c:if test="${boardMap.next}">
									<li><a href="${pageContext.request.contextPath}/tboard/list2?crtPage=${boardMap.endPageBtnNo+1}">▶</a></li>
								</c:if>
							</ul>
